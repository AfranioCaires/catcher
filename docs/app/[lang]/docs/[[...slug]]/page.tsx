    ...
    <>
      <article className={styles.pageContent}>
        ...
        <FooterNav
          ...
          next={neighbours.next ? { url: neighbours.next.url, title: neighbours.next.name as string } : null}
          previous={
            neighbours.previous ? { url: neighbours.previous.url, title: neighbours.previous.name as string } : null
          }
        />
      </article>
