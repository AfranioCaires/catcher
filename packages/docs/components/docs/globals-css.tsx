...
function extractPaletteValues(
  ...
  const selectorPattern =
    mode === "light"
      ? new RegExp(
          `\\.light\\[data-palette="${palette}"\\]|\\[data-theme="light"\\]\\[data-palette="${palette}"\\]`,
        )
      : new RegExp(
          `\\.dark\\[data-palette="${palette}"\\]|\\[data-theme="dark"\\]\\[data-palette="${palette}"\\]`,
        );
...
function processLine(
  line: string,
  state: { inLightBlock: boolean; inDarkBlock: boolean; braceCount: number },
) {
