  ...
  data={[
    {
      ...
      required: true,
      description: 'The Promise or function returning a value or Promise to execute and catch potential errors from.',
    },
    {
      prop: 'errorsToCatch',
      type: 'ErrorClass[]',
  ...
  data={[
    {
      ...
      type: 'Promise<T> | (() => T | Promise<T>)',
      required: true,
      description: 'The Promise or function returning a value or Promise to execute.',
    },
    {
      prop: 'timeoutMs',
      type: 'number',
