...
import { anchoredToastManager } from '@/components/ui/toast/toast'
...
function InstallButton({ name }: { name: string }) {
  ...
  const command = `npx shadcn@latest add Catcher/${name}${suffix}`
    ...
    <div className={styles.viewer}>
      <Tabs className={styles.tabs} defaultValue="preview">
        ...
        <TabsContent className={styles.previewPanel} value="preview">
          <div className={full ? styles.previewContainerFull : styles.previewContainer}>
            {children}
          </div>
        </TabsContent>
              ...
              {currentFile ? (
                ...
                >
                  <CodeBlock.Header className={styles.codeHeader}>
                    ...
                    <CodeBlock.Filename className={styles.fileName}>
                      {currentFile.name}
                    </CodeBlock.Filename>
                    <CodeBlock.Actions>
