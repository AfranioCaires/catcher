  ...
  return (
    <section aria-labelledby="props-heading" className={styles.container}>
      ...
      <div className={styles.header}>
        <div className={styles.headerCell}>{t.prop}</div>
        <div className={styles.headerCell}>{t.type}</div>
        <div className={styles.headerCell}>{t.default}</div>
      </div>
          ...
          <Collapsible className={styles.collapsible} key={`prop-${row.prop}-${index}`}>
            ...
            <CollapsiblePanel className={styles.panel} hiddenUntilFound>
              <div className={styles.panelRow}>
                <div className={styles.detailLabel}>{t.name}</div>
              ...
              <div className={styles.panelRow}>
                <div className={styles.detailLabel}>{t.description}</div>
                <div className={styles.detailValueSpan}>{row.description}</div>
              </div>

              <div className={styles.panelRow}>
                <div className={styles.detailLabel}>{t.type}</div>
              ...
              <div className={styles.panelRow}>
                <div className={styles.detailLabel}>{t.default}</div>
                <div className={styles.detailValue}>
                  {row.default ? (
                    <code className={styles.code}>{renderDefaultValue(row.default)}</code>
                  ) : (
