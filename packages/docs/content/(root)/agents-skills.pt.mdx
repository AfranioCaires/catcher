...
<CodeBlockTab value="npm">
  ```bash npx skills add https://github.com/afraniocaires/catcher --skill --catcher ```
</CodeBlockTab>

<CodeBlockTab value="pnpm">
  ```bash pnpm dlx skills add https://github.com/afraniocaires/catcher --skill --catcher ```
</CodeBlockTab>

<CodeBlockTab value="yarn">
  ```bash yarn dlx skills add https://github.com/afraniocaires/catcher --skill --catcher ```
</CodeBlockTab>
