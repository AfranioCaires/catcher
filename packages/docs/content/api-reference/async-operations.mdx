  ...
  data={[
    {
      ...
      required: true,
      description: 'The Promise or function returning a Promise to execute and catch potential errors from.',
    },
    {
      prop: 'errorsToCatch',
      type: 'ErrorClass[]',
  ...
  data={[
    {
      ...
      type: 'Promise<T> | (() => Promise<T>)',
      required: true,
      description: 'The Promise or function returning a Promise to execute.',
    },
    {
      prop: 'timeoutMs',
      type: 'number',
